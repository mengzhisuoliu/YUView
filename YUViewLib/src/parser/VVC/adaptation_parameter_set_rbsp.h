...
constexpr EnumMapper<APSParamType, 3> APSParamTypeMapper = {
    std::make_pair(APSParamType::ALF_APS, "ALF_APS"),
    std::make_pair(APSParamType::LMCS_APS, "LMCS_APS"),
    std::make_pair(APSParamType::SCALING_APS, "SCALING_APS")};
